...
def create_labels():
    dat=(pd.read_csv(os.path.join("label", "azimuthlabels_filtered_40bin.csv"), header=None))
    return dat.to_numpy()
...
model = joblib.load('xgboost_azimuth_40bin_final.dat')
#model.fit(trainsm, labelsm)
