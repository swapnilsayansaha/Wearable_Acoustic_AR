...
if (rw_state_read(4) == 0)
    write(rw_state, [83 103 2 1 100], "uint8" ,"withresponse"); %DO NOT MODIFY ANYTHING HERE. IT'S SET TO BEST POSSIBLE SETTING
end
...
accxcal = bin2dec(strcat(dec2bin(offset(10)), dec2bin(offset(11))))/16;
accycal = bin2dec(strcat(dec2bin(offset(12)), dec2bin(offset(13))))/16;
acczcal = bin2dec(strcat(dec2bin(offset(14)), dec2bin(offset(15))))/16;
acccalstr = ['Accelerometer calibration trim (x, y, z): ', num2str(accxcal), ' ' num2str(accycal), ' ', num2str(acczcal)];
disp(acccalstr);
gyroxcal = bin2dec(strcat(dec2bin(offset(4)), dec2bin(offset(5))));
gyroycal = bin2dec(strcat(dec2bin(offset(6)), dec2bin(offset(7))));
gyrozcal = bin2dec(strcat(dec2bin(offset(8)), dec2bin(offset(9))));
...
for i = 1:n
    ...
    z(1,1) = bin2dec(strcat(dec2bin(sensorData(11)), dec2bin(sensorData(12))))/SFacc;
    z(1,2) = bin2dec(strcat(dec2bin(sensorData(13)), dec2bin(sensorData(14))))/SFacc;
    z(1,3) = bin2dec(strcat(dec2bin(sensorData(15)), dec2bin(sensorData(16))))/SFacc;
    %angular velocity given as deg/s.
    z(1,4) = bin2dec(strcat(dec2bin(sensorData(5)), dec2bin(sensorData(6))))/SFgyr;
    z(1,5) = bin2dec(strcat(dec2bin(sensorData(7)), dec2bin(sensorData(8))))/SFgyr;
    z(1,6) = bin2dec(strcat(dec2bin(sensorData(9)), dec2bin(sensorData(10))))/SFgyr;
